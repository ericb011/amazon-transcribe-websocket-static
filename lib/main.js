...
$('#email-button').click(function (){
	...
	AWS.config.update({region: 'us-east-1',accessKeyId: $('#access_id').val(),secretAccessKey:  $('#secret_key').val()});

// Create publish parameters
var params = {
    Message: $('#transcript').val(), /* required */
    TopicArn: 'arn:aws:sns:us-east-1:397089171026:SendEmail'
};
